...
//        pageLabel.frame =CGRectMake(20, MainScreenHeight - 40, 100, 20);
...
//        if (weakSelf.navigationHeight) {
        originalFrame.origin.y += 64;//weakSelf.navigationHeight;
//        }
...
- (void)showPickerVc:(UIViewController *)vc{
    ...
    if (weakVc != nil) {
        if (([vc isKindOfClass:[UITableViewController class]] || [vc isKindOfClass:[UICollectionView class]]) && weakVc.navigationController != nil) {
            self.navigationHeight = 64;//CGRectGetMaxY(weakVc.navigationController.navigationBar.frame);
        }
